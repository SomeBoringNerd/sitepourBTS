<html>
	...
	<?php include("../../entete.php"); ?>
		...
		<br><br><br>
		<center>
			<megaTitle>SCP-963</megaTitle><br><br>
			<lesserTitle>L'Immortalité</lesserTitle>
			...
			<div id="personnage">
				...
				<img src="../../rescources/img/SCP-963.png" height="200" width="200" id="broder" title="Image créée par le talentueux SunnyClockwork sur deviantart">

				<p>alias :<br>L'Immortalité</p>
				<p>zone  :<br><a href="wiki/characters/PS_JackBright.html" target="_parent">Autour du cou du Dr.Bright</a></p>
				<p>statut :<br>Item a usage unique</p>
                <p>usage :<br>pendant un combat</p>
		...
		<div id="text_zone">
			...
			<p>SCP-963 est un collier pesant 3kg, composé de métal et d'une pierre rouge en son centre permettant au <a href="wiki/characters/PS_JackBright.html" target="_parent">Dr.Bright</a>
				de ne jamais mourrir.
                

			</p><br>
			<center><lesserTitle>Histoire</lesserTitle></center>	

			<p>
                Avant d'appartenir au <a href="wiki/characters/PS_JackBright.html" target="_parent">Dr.Bright</a>,
                ...
                peut avant une brêche de confinement de <a href="wiki/characters/B_SCP-682.html" target="_parent">SCP-682</a>, qui
                comme a son habitude causera un massacre, et tua le docteur.<br><br>
